...
PRICE_OVERRIDE_TOKEN_MAX_AGE = int(os.getenv("PRICE_OVERRIDE_TOKEN_MAX_AGE", "300"))
PRICE_OVERRIDE_TOKEN_SALT = os.getenv("PRICE_OVERRIDE_TOKEN_SALT", "price-override")
