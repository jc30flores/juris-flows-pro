...
def get_dte_base_url() -> str:
    ...
    base_value = getattr(settings, "DTE_API_BASE_URL", "") or ""
    if base_value:
        base_url = _normalize_base_url(base_value, source_label="DTE_API_BASE_URL")
    else:
        legacy_value = (
        ...
        base_url = _normalize_base_url(legacy_value, source_label="DTE_FACTURA_URL")
